...
function doPost_Test_Transition() {
  ...
  Object.keys(NyanatorMode).forEach(key => doPost_Test_StartXXXX(NyanatorMode[key].mode, "testuser"));
};
...
function doPost_Test_Summarize() {
  ...
  if (doPost_Test_StartXXXX(NyanatorMode.SUMMARIZE.mode, testUser)) {
    doPost(
      {
        'postData': {
          'contents': JSON.stringify(
...
function doPost_Test_TextToImage() {
  ...
  const testUser = "testuser";
  if (doPost_Test_StartXXXX(NyanatorMode.TEXT_TO_IMAGE.mode, testUser)) {
    doPost(
      {
        'postData': {
          'contents': JSON.stringify(
...
function doPost_Test_JpTranslation() {
  ...
  const testUser = "testuser";
  if (doPost_Test_StartXXXX(NyanatorMode.JP_TRANSLATION.mode, testUser)) {
    doPost(
      {
        'postData': {
          'contents': JSON.stringify(
...
function doPost_Test_EnTranslation() {
  ...
  const testUser = "testuser";
  if (doPost_Test_StartXXXX(NyanatorMode.EN_TRANSLATION.mode, testUser)) {
    doPost(
      {
        'postData': {
          'contents': JSON.stringify(
...
function doPost_Test_Chatbot() {
  ...
  const testUser = "testuser";
  if (doPost_Test_StartXXXX(NyanatorMode.CHATBOT.mode, testUser)) {
    doPost(
      {
        'postData': {
          'contents': JSON.stringify(
